    ...
    <table class="layui-table" >
        ...
        <c:forEach items="${noticeList}" var="c">
            ...
            <tr>
                ...
                <td>
                    <a href="/admin/notice/edit/${c.noticeId}" class="layui-btn layui-btn-sm">编辑</a>
                    <a href="/admin/notice/delete/${c.noticeId}" class="layui-btn layui-btn-danger layui-btn-sm" onclick="return confirmDelete()">删除</a>
                </td>
                <td >${c.noticeId}</td>
            </tr>
