...
<rapid:override name="left">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			<article class="post" id="articleDetail" data-id="${messageBoard.articleId}">
				<header class="entry-header">
					<h1 class="entry-title">
							${messageBoard.articleTitle}
					</h1>
				</header><!-- .entry-header -->
				<div class="entry-content">
					<div class="single-content">
							${messageBoard.articleContent}
					</div>
					<div class="clear"></div>
					<div id="social">
							...
							<c:if test="${sessionScope.user!=null}">
								<li class="edit-link">
									<a target="_blank" class="post-edit-link"
									   href="${pageContext.request.contextPath}/admin/article/edit/${messageBoard.articleId}">编辑</a>
								</li>
							</c:if>
							<li class="comment">
								<a href="${pageContext.request.contextPath}/article/${messageBoard.articleId}#comments"
				...
				<div id="respond" class="comment-respond">
					<h3 id="reply-title" class="comment-reply-title"><span id="reply-title-word">留言</span>
						<a rel="nofollow" id="cancel-comment-reply-link"
						   href="${pageContext.request.contextPath}/article/${messageBoard.articleId}#respond"
						   style="">取消回复</a>
					</h3>
					<form id="message_form" method="post">
						...
						<div class="clear"></div>
						<p class="form-submit">
							<input id="submit" name="submit" type="submit" tabindex="5" value="提交留言">
							<input type="hidden" name="commentArticleId"
								   value="${messageBoard.articleId}" id="article_id">
